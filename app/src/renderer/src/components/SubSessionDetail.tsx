    ...
    >
      ...
      >
        ...
        <section className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-5 py-3 text-sm leading-relaxed text-slate-100">
            {row.output ? (
              <Markdown>{row.output}</Markdown>
            ) : (
              <div className="text-slate-500">(아직 출력 없음)</div>
            )}
          </div>
        </section>
      </div>
